[[https://wequant.io/study/strategy.ar.html][AR（人气指标）策略]]
...
#+begin_src python :results output :exports both
  ...
  # 关键词：价格波动、超买超卖。
  # 方法：
  # 1)利用一段时间内开盘价在最高价和最低价中所处的位置构建 AR 人气指标
  ...
  def handle_data(context):
      ...
      context.log.info("当前 AR 值为: %s" % ar)

      # AR 值小于超卖线且拥有资金，则全仓买入
      if ar < context.user_data.over_sell:
          context.log.info("AR 超过了超卖线，产生买入信号")
      ...
      # AR 值大于超买线且有持仓，则全仓卖出
          ...
          context.log.info("AR 超过了超买线，产生卖出信号")
